...
- The full roster table contains exactly one row per eligible account.
- The roster row count equals Eligible Accounts.
...
|---:|---:|---:|---:|---:|---:|
| [count] | [count] | [count] | [count] | [count] | [percentage or N/A] |

All Assigned Accounts — complete roster
| # | Account | Cadence Health | Sync / Frequency | Last / Next Confirmed | Recurring Evidence | Gap / Next Action | Cadence Task |
|---:|---|---|---|---|---|---|---|
| 1 | [Account] | [one health state] | [sync; frequency] | [last; next] | [short trusted evidence] | [gap and one action; or maintain cadence] | [active task or appropriate no-task label] |
```

The full roster is mandatory and uncapped. Never replace it with only exceptions, a sample,
“top accounts,” or a statement that additional rows were omitted.

Sort rows by actionability:
...
Within each state, sort urgent or overdue cadence tasks first, then alphabetically.
...
After the roster, include `Data Quality Notes` only when source completeness, conflicting
records, or uncaptured dates materially affect interpretation.
...
accounts. Weekly Command Centre may summarize cadence and emphasize exceptions; this skill
must always provide the literal full roster.
